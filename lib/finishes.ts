export const FINISHES = [
  ...
  'Bordeaux','Branco','BrancoMate','Dourado','Castanho','Cinza',
  'CremeClaro','CremeEscuro','Cromado','Preto','GunMetal',
  'PretoMate','PretoFosco','Rosa','VerdeAgua','VerdeFloresta','Vermelho',
] as const;
...
export const FINISH_META: Record<FinishName, {
  ...
  Dourado:{hex:'#8c6c3f',roughness:0.28,metalness:0},
  ...
  GunMetal:{hex:'#151515',roughness:0.15,normalScale:0.35,metalness:0},
  PretoMate:{hex:'#0f0f0f',roughness:0.6,metalness:0},
  PretoFosco:{hex:'#111111',roughness:0.5,metalness:0},
